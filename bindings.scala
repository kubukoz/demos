...
object structs:
  ...
  */
   ...
   * [bindgen] header: include/hidapi.h
  */
  opaque type hid_device_info = CStruct11[CString, CUnsignedShort, CUnsignedShort, Ptr[wchar_t], CUnsignedShort, Ptr[wchar_t], Ptr[wchar_t], CUnsignedShort, CUnsignedShort, CInt, Ptr[Byte]]
  object hid_device_info:
    given _tag: Tag[hid_device_info] = Tag.materializeCStruct11Tag[CString, CUnsignedShort, CUnsignedShort, Ptr[wchar_t], CUnsignedShort, Ptr[wchar_t], Ptr[wchar_t], CUnsignedShort, CUnsignedShort, CInt, Ptr[Byte]]
    def apply()(using Zone): Ptr[hid_device_info] = scala.scalanative.unsafe.alloc[hid_device_info](1)
    def apply(path : CString, vendor_id : CUnsignedShort, product_id : CUnsignedShort, serial_number : Ptr[wchar_t], release_number : CUnsignedShort, manufacturer_string : Ptr[wchar_t], product_string : Ptr[wchar_t], usage_page : CUnsignedShort, usage : CUnsignedShort, interface_number : CInt, next : Ptr[hid_device_info])(using Zone): Ptr[hid_device_info] = 
      val ____ptr = apply()
      (!____ptr).path = path
...
private[libhidapi] object extern_functions:
  ...
  */
   ...
   * [bindgen] header: include/hidapi.h
  */
  def hid_get_feature_report(device : Ptr[hid_device], data : Ptr[CUnsignedChar], length : size_t): CInt = extern
   ...
   * [bindgen] header: include/hidapi.h
  */
  def hid_get_indexed_string(device : Ptr[hid_device], string_index : CInt, string : Ptr[wchar_t], maxlen : size_t): CInt = extern
   ...
   * [bindgen] header: include/hidapi.h
  */
  def hid_get_manufacturer_string(device : Ptr[hid_device], string : Ptr[wchar_t], maxlen : size_t): CInt = extern
   ...
   * [bindgen] header: include/hidapi.h
  */
  def hid_get_product_string(device : Ptr[hid_device], string : Ptr[wchar_t], maxlen : size_t): CInt = extern
   ...
   * [bindgen] header: include/hidapi.h
  */
  def hid_get_serial_number_string(device : Ptr[hid_device], string : Ptr[wchar_t], maxlen : size_t): CInt = extern
  ...
  */
   ...
   * [bindgen] header: include/hidapi.h
  */
  def hid_send_feature_report(device : Ptr[hid_device], data : Ptr[CUnsignedChar], length : size_t): CInt = extern
